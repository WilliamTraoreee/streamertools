export default function Privacy() {
  return (
    <div className="w-full px-6 lg:w-3/5 py-20 mx-auto">
      ...
      <ul>
        ...
        <li>
          <p className="mb-3">
            ...
            &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Intraweb SAS, 15 rue des
            postiers, 67300 Schiltigheim.
          </p>
        </li>
        <li>
          <p className="mb-3">
        ...
        <li>
          <p className="mb-3">
            <strong>Website</strong> refers to StreamerTools, accessible from{' '}
            <a
              href="https://streamertools.app"
              rel="external nofollow noopener noreferrer"
              target="_blank"
            >
              https://streamertools.app
            </a>
          </p>
        </li>
        <li>
      ...
      <h2 className="text-2xl font-bold mb-3">Collecting and Using Your Personal Data</h2>
      <h3 className="text-xl font-bold mb-3">Types of Data Collected</h3>
      <h4>Personal Data</h4>
      <p className="mb-3">
      ...
      <h3 className="text-xl font-bold mb-3">Use of Your Personal Data</h3>
      ...
      <h3 className="text-xl font-bold mb-3">Retention of Your Personal Data</h3>
      <p className="mb-3">
        ...
        <h3 className="text-xl font-bold mb-3">Transfer of Your Personal Data</h3>
        <p className="mb-3">
        ...
        <h3 className="text-xl font-bold mb-3">Delete Your Personal Data</h3>
        <p className="mb-3">
        ...
        <h3 className="text-xl font-bold mb-3">Disclosure of Your Personal Data</h3>
        ...
        <h3 className="text-xl font-bold mb-3">Security of Your Personal Data</h3>
        <p className="mb-3">
        ...
        <p className="mb-3">
          ...
          advise You to review the Privacy Policy
        </p>
      ...
      <ul>
        <li>By email: privacy@intraweb.fr</li>
      </ul>
    </div>
  )
}
